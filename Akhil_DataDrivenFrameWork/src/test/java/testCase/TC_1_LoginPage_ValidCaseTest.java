 ...
 * */
public class TC_1_LoginPage_ValidCaseTest extends driverinstance {
	private String sTestCaseName;
	private int iTestCaseRow;
	
	@Test(dataProvider="Authentication")
	
	public void tc_01_login_Test(String uname, String pass) throws Exception
	...
	public Object[][] Authentication() throws Exception 
		{
			...
			Object[][] testObjArray = ExcelUtils.getTableArray("./TestData/TestData.xlsx", "testdata",iTestCaseRow);
	    	return (testObjArray);
