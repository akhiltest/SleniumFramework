...
public static void	finalreport(ITestResult result,WebDriver driver,String className) throws IOException
{
	...
	ExtentHtmlReporter reporter=new ExtentHtmlReporter("./ExtentReports/"+className+"_"+millisStart+".html");
    ...
    if(result.getStatus()==ITestResult.FAILURE)
 	{ 
				...
				logger.log(Status.FAIL, MarkupHelper.createLabel(result.getMethod().getMethodName()+" Test case FAILED due to below issues:", ExtentColor.RED));
